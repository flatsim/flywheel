...
inline BlockAllocator::BlockAllocator(int32 initialChunkSize)
    : blockCount{ 0 }
    , chunkCount{ 0 }
    , chunks{ nullptr }
{
...
inline void* BlockAllocator::Allocate(int32 size)
{
    if (size == 0)
    {
        return nullptr;
...
inline void BlockAllocator::Free(void* p, int32 size)
{
    if (size == 0)
    {
        return;
...
inline void BlockAllocator::Clear()
{
    Chunk* chunk = chunks;
    while (chunk)
    {
...
inline void BlockAllocator::Clear(int32 initialChunkSize)
{
    Clear();
...
inline int32 BlockAllocator::GetChunkSize(int32 size) const
{
    int32 index = size / block_unit;
