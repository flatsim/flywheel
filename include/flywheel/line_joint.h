...
inline void LineJoint::Prepare(const Timestep& step)
{
...
inline void LineJoint::SolveVelocityConstraints(const Timestep& step)
{
    MuliNotUsed(step);
...
inline void LineJoint::ApplyImpulse(float lambda)
{
    // V2 = V2' + M^-1 ⋅ Pc
    // Pc = J^t ⋅ λ
